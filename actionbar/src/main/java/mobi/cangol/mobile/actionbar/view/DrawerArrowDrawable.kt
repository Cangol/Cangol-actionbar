 ...
 */
class DrawerArrowDrawable constructor(resources: Resources, private val rounded: Boolean = false) : Drawable() {
     ...
     */
    private class JoinedPath internal constructor(pathFirst: Path, pathSecond: Path) {
     ...
     */
    private inner class BridgingLine internal constructor(private val pathA: JoinedPath, private val pathB: JoinedPath) {
    ...
    companion object {
         ...
         */
        private val STROKE_WIDTH_DP = 1.5f
